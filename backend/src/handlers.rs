...
pub async fn get_itmes(db_pool: web::Data<Pool>, path: web::Path<(i32,)>) -> impl Responder {
...
pub async fn check_itme(db_pool: web::Data<Pool>, path: web::Path<(i32, i32)>) -> impl Responder {
